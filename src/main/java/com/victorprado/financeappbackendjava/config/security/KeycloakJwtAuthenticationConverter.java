...
/**
 * Classe responsavel por converter o token gerado pelo Keycloak de maneira a atribuir os
...
public class KeycloakJwtAuthenticationConverter implements
  ...
  private Set<String> getRealmRoles(Jwt jwt) {
    ...
    json.elements().forEachRemaining(e -> e.elements()
  ...
  private Set<String> getResourceRoles(Jwt jwt) {
    ...
    Map<String, JsonNode> map = objectMapper.convertValue(jwt.getClaim("resource_access"), typeReference);
